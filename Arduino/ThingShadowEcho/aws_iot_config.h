...
//===============================================================
#define AWS_IOT_MQTT_HOST "A4RRXFQV1H7HR.iot.us-east-1.amazonaws.com"   // your endpoint
#define AWS_IOT_MQTT_PORT 8883                  // your port
#define AWS_IOT_CLIENT_ID "yun-test"            // your client ID
#define AWS_IOT_MY_THING_NAME "yun-test"            // your thing name
#define AWS_IOT_ROOT_CA_FILENAME "root-CA.crt"           // your root-CA filename
#define AWS_IOT_CERTIFICATE_FILENAME "2ac7b9a6c0-certificate.pem.crt"                 // your certificate filename
#define AWS_IOT_PRIVATE_KEY_FILENAME "2ac7b9a6c0-private.pem.key"              // your private key filename
//===============================================================
